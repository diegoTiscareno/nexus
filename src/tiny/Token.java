...
public class Token implements Serializable{
    ...
    public static final String[] literalesToken={
        ...
        "while", "cout", "cin", "tipo int", "real", "main", "más", "menos",
        ...
        "decremento", "identificador", "número", "tipo void", "tipo boolean"
    };
    ...
    public Token(TipoToken tipoToken, String lexema, int indice, int linea, int index) {
    ...
    public boolean selectReservedWord(){
        if (this.lexema != null){
            if(Token.isReservedWord(lexema)){
                switch (lexema) {
                    case "if":
                    ...
                    case "main":
                        ...
                        break;
                    case "boolean":
                        this.tipoToken = TipoToken.BOOLEAN;
                        break;
                    case "void":
    ...
    public String toString() {
        ...
        return "Token: " + tipoToken.toString() + " - Lexema: " + lexema;
    }
